...
{
    // 2026-09-23 用户定调: 稀有度 Rare → Basic, 并**雪藏**
    // (shouldShowInCardLibrary = false → 不出现在卡牌图鉴/牌库中, 但仍可通过其它途径获得)。
    public DongNiZhiBa() : this(2, CardType.Power, CardRarity.Basic, TargetType.Self, false)
    {
        WithCostUpgradeBy(-1);
    }
