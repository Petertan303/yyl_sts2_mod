...
public class yylHook
{
    ...
    public static Task OnStanceChange(PlayerChoiceContext ctx, Player player, yylStanceModel oldStance,
    ...
    ///     The scry amount after <see cref="yylHook.ModifyScryAmount" /> modifiers, as requested —
